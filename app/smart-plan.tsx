      ...
      >
        ...
        <View style={styles.blockCard}>
          ...
          <Text style={styles.blockDesc}>
            Finish proposal sections: pricing & terms. Phone on Do Not Disturb.
          </Text>
              ...
              <View style={styles.timelineCard}>
                ...
                <View style={styles.timelineActions}>
                  <TouchableOpacity style={styles.textBtn}>
                    <Text style={styles.textBtnText}>Details</Text>
                  </TouchableOpacity>
                  <TouchableOpacity style={styles.textBtn}>
                    <Text style={styles.textBtnText}>Mark done</Text>
                  </TouchableOpacity>
                </View>
              </View>
            </View>
            ...
            <View style={styles.taskCard}>
              ...
              <View style={styles.taskActions}>
                <TouchableOpacity style={styles.secondaryBtnSmall}>
                  <Text style={styles.secondaryBtnSmallText}>Snooze</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.primaryBtnSmall}>
                  <Text style={styles.primaryBtnSmallText}>Open</Text>
                </TouchableOpacity>
              </View>
            </View>
          )}
...
const styles = StyleSheet.create({
  ...
  metricCard: { flex: 1, backgroundColor: "white", borderRadius: 16, padding: 14, borderWidth: 1, borderColor: "#eef0f4" },
